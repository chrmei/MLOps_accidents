...
class BaseTrainer(ABC):
    ...
    def __init__(self, config: Dict):
        ...
        self.features_path = paths_config.get("features", "data/preprocessed/features.csv")
        self.metrics_dir = paths_config.get("metrics_dir", "data/metrics")
        self.label_encoders_path = paths_config.get("label_encoders", "models/label_encoders.joblib")
        self.model_metadata_path = paths_config.get("model_metadata", "models/trained_model_metadata.joblib")
    ...
    @abstractmethod
    def _build_model(self, X_train: pd.DataFrame, y_train: pd.Series, use_grid_search: bool = False):
        """
    ...
    def get_registered_model_name(self) -> str:
        ...
        model_type_capitalized = self.model_type.replace("_", " ").title().replace(" ", "_")
